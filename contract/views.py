...
def sector_manager_action(request, pk):
    ...
    Sector_manager_action_h = form.Sector_manager_action.all()
    Check_data_action_h = form.Check_data_action.all()
    Cost_estimation_action_h = form.Cost_estimation_action.all()
    Financial_action_h = form.Financial_action.all()
    Copy_contract_action_h = form.Copy_contract_action.all()
    Check_contract_action_h = form.Check_contract_action.all()
    TCTA_action_h = form.TCTA_action.all()
    EVP_action_h = form.EVP_action.all()
    CEO_action_h = form.CEO_action.all()
    Assignmnt_action_h = form.Assignmnt_action.all()
...
#  اجراء مدير القطاع 
    ...
    context = {
        ...
        'Sector_manager_action_h':Sector_manager_action_h,
        'Check_data_action_h':Check_data_action_h,
        'Cost_estimation_action_h':Cost_estimation_action_h,
        'Financial_action_h':Financial_action_h,
        'Copy_contract_action_h':Copy_contract_action_h,
        'Check_contract_action_h':Check_contract_action_h,
        'TCTA_action_h':TCTA_action_h,
        'EVP_action_h':EVP_action_h,
        'CEO_action_h':CEO_action_h,
        'Assignmnt_action_h':Assignmnt_action_h,
    }
    if request.user.is_staff:
